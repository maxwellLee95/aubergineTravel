      ...
      <div class="st-guide">
    	...
    	<div class="st-main-page">
		  ...
		  <div class="dest-sum-box">
            ...
            <span class="num morepic" data-url="{$GLOBALS['cfg_basehost']}/photos/{$info['pinyin']}/"><i></i>查看更多图片</span>
          </div>
        	<div class="dest-sum-txt">
          	<h3>{$info['kindname']}</h3>
            <div class="nr">{strip_tags(Common::cutstr_html($info['jieshao'],280))}  <a class="more" href="javascript:;">[详细简介]</a></div>
          </div>
        </div><!-- 目的地概括 -->
