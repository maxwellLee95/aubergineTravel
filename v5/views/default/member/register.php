        ...
        <div class="reg-tig-box">
          ...
          <dl>
            ...
            <dd>
                ...
                <a class="qq qqlogin" href="{$GLOBALS['cfg_basehost']}/member/login/qq">QQ</a>
                {/if}
                {if (!empty($GLOBALS['cfg_weixi_appkey']) && !empty($GLOBALS['cfg_weixi_appsecret']))}
                <a class="wx wxlogin" href="{$GLOBALS['cfg_basehost']}/member/login/weixin">wx</a>
                {/if}

                {if (!empty($GLOBALS['cfg_sina_appkey']) && !empty($GLOBALS['cfg_sina_appsecret']))}
                <a class="wb wblogin" href="{$GLOBALS['cfg_basehost']}/member/login/sina">wb</a>
                {/if}
            </dd>
          </dl>
        </div>
