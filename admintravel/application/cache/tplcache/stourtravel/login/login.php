...
<div class="login-box">
    <div class="head-box">
        <span class="head-version" style="display: none">V<?php echo $majorVersion;?></span>
        <a href="#" target="_blank"><img class="fl" src="<?php echo $GLOBALS['cfg_public_url'];?>images/gw-blank-ico.png" /></a>
    </div>
