                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <div class="save-value-div mt-2 ml-10 marshal-point-sel">
                                    <?php $n=1; if(is_array($info['marshal_point_arr'])) { foreach($info['marshal_point_arr'] as $k => $v) { ?>
                                    <span><s onclick="$(this).parent('span').remove()"></s><?php echo $v['name'];?><input type="hidden" name="marshal_point[]" value="<?php echo $v['id'];?>"></span>
                                    <?php $n++;}unset($n); } ?>
                                </div></dd>
                        </dl>
                        <dl>
                            <dt>线路专题：</dt>
                            <dd>
                                <?php $n=1; if(is_array($theme_arr)) { foreach($theme_arr as $id => $v) { ?>
                                    <input <?php if(in_array($id,$info['themelist_arr'])){ echo 'checked';}?> type="checkbox"  name="themelist[]" value="<?php echo $id;?>" /><?php echo $v;?>
                                <?php $n++;}unset($n); } ?>
                            </dd>
                        </dl>
                    </div>
 ...
 value="1">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<input style="display:none" type="checkbox" name="islinebefore" value="1" <?php if($info['islinebefore']==1) { ?>checked="checked"<?php } ?>
/><span style="display:none" class="ml-5">报价显示限制提前天数</span>
                            </dd>
                        </dl>
                        <dl>
                            <dt>总成行人数：</dt>
                            <dd>
                                <input type="text" class="set-text-xh mt-2" name="person_count" value="<?php echo $info['person_count'];?>"/>
                            </dd>
                        </dl>
                        <dl>
                            <dt>最低成行人数：</dt>
                            <dd>
                                <input type="text" class="set-text-xh mt-2" name="min_person_count" value="<?php echo $info['min_person_count'];?>"/>
                            </dd>
                        </dl>
                        <dl>
                            <dt>市场价：</dt>
                        ...
                        <dl>
                            ...
                            <dd>
                                <select name="difficultylevel">
                                    <?php $n=1; if(is_array($difficulty_list)) { foreach($difficulty_list as $id => $v) { ?>
                                    <option value="<?php echo $id;?>" <?php if($info['difficultylevel']==$id) { ?>selected="selected"<?php } ?>
><?php echo $v;?></option>
                                    <?php $n++;}unset($n); } ?>
                                </select>
                            </dd>
                        ...
                        <dl>
                            ...
                            <dd>
                                <select name="line_type">
                                    <option value="1" <?php if($info['line_type']==1 || empty($info['line_type']) ) { ?>selected="selected"<?php } ?>
>普通线路（默认）</option>
                                    <option value="2" <?php if($info['line_type']==2) { ?>selected="selected"<?php } ?>
>自选线路</option>
                                    <option value="3" <?php if($info['line_type']==3) { ?>selected="selected"<?php } ?>
>订制线路</option>
                                </select>
                            </dd>
                        </dl>
                        ...
                        <dl style="display: none">
                            <dt>儿童标准：</dt>
                            <dd>
                                <input type="text" class="set-text-xh mt-2" name="childrule" value="<?php echo $info['childrule'];?>"/>
                    ...
                    <div class="add-class">
                        <dl>
                            <dt>保险说明：</dt>
                            <dd>
                                <input type="text" class="set-text-xh text_700 mt-2" name="insurance_tips" value="<?php echo $info['insurance_tips'];?>"/>
                            </dd>
                        </dl>
                        <dl>
                            <dt>推文链接：</dt>
                            <dd>
                                <input type="text" class="set-text-xh text_700 mt-2" name="custom_promotion_link" value="<?php echo $info['custom_promotion_link'];?>"/>
                            </dd>
                        </dl>
                        <dl>
                            <dt>微信分享描述：</dt>
                            <dd>
                                <input type="text" class="set-text-xh text_700 mt-2" name="share_desc" value="<?php echo $info['share_desc'];?>"/>
                            </dd>
                        </dl>
                    </div>
                    <div class="add-class">
                            ...
                            <dd>
                                <div>
                                    ...
                                    <div style="margin-top: 30px;">
                                        <?php if(!empty($info['qrcode'])) { ?>
                                        <img id="qrcode_img" src="<?php echo $info['qrcode'];?>"   />
                                        <?php } else { ?>
                                        <img id="qrcode_img" src="#" />
                                        <?php } ?>
                                    </div>
                                </div>
                                <input  type="hidden" class="set-text-xh text_700 mt-2" id="qrcode" name="qrcode" value="<?php echo $info['qrcode'];?>"/>
                            </dd>
                        </dl>
                        <dl>
                            <dt>二维码说明：</dt>
                            <dd>
                                <input type="text" class="set-text-xh text_700 mt-2" name="qrcode_text" value="<?php echo $info['qrcode_text'];?>"/>
                            </dd>
                        </dl>
                    </div>
  ...
  href="javascript:void(0)" data-value="<?php echo $r['path'];?>" onclick="setTemplet(this)"><?php echo $r['templetname'];?></a>
                    ...
                    <div  class="add-class">
                        <dl>
                            <dt>模块：</dt>
                            <dd>
                                <?php $n=1; if(is_array($index_module_arr)) { foreach($index_module_arr as $id => $v) { ?>
                                    <?php echo $v;?> <input <?php if(in_array($id,$info['index_module_ids'])){ echo 'checked';}?> type="checkbox"  name="index_module_ids[]" value="<?php echo $id;?>" />
                                <?php $n++;}unset($n); } ?>
                            </dd>
                        </dl>
                        <dl>
                            <dt>首页标题：</dt>
                            <dd><input type="text" name="index_title" value="<?php echo $info['index_title'];?>" class="set-text-xh mt-2"/></dd>
                        </dl>
                        <dl>
                            <dt>首页小标题：</dt>
                            <dd><input type="text" name="index_sub_title" value="<?php echo $info['index_sub_title'];?>" class="set-text-xh mt-2"/></dd>
                        </dl>
                        <dl>
                            <dt>图标：</dt>
                            <dd id="dd_logo">
