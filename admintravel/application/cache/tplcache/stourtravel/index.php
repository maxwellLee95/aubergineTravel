...
<head>
    <meta charset="utf-8">
    <title><?php echo $configinfo['cfg_webname'];?></title>
...
<div class="header" id="header">
    <div class="top-page">
        ...
        <div class="top-operate">
            <ul class="fl">
                <li class="web-home" style="display: none"><a href="../" target="_blank">网站首页</a></li>
                <li class="clear-style"><a href="javascript:;" id="clearbtn">清除缓存</a></li>
                <li class="create-txt" style="display: none"><a href="javascript:;" id="makehtml">生成html</a></li>
