            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        if (id.indexOf('add') != -1)
                            return '';
                        return "<a href='javascript:void(0);' class='row-mod-btn' onclick=\"modify(" + id + ")\"></a>&nbsp;&nbsp;&nbsp; <a href='javascript:void(0);' class='row-del-btn' onclick=\"del(" + id + ")\"></a>";
                    }
                }
            ],
            plugins: [
...
function modify(id)
{
    var url=SITEURL+"startplace/edit/parentkey/startplace/itemid/1/id/"+id;
