    ...
    Ext.onReady(
        function()
        {
            ...
            $("#addbtn").click(function(){
                ST.Util.addTab('添加',SITEURL+'leaderexamresult/add/parentkey/sale/itemid/');
            });

            //产品store
            window.product_store=Ext.create('Ext.data.Store',{
                fields:['id','title','date','questions_count','addtime','leader','status'],
                proxy:{
                    type:'ajax',
                    api: {
                        read: SITEURL+'leaderexamresult/list/action/read',  //读取数据的URL
                        update:SITEURL+'leaderexamresult/list/action/save',
                        destroy:SITEURL+'leaderexamresult/list/action/delete'
                    },
                    reader:{
                        type: 'json',   //获取数据的格式
                        root: 'lists',
