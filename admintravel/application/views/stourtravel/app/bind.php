...
<!--<div id="bindinfo">
    <ul>
        <li class="h30"><span class="fl">授权ID:</span><input type="text" class="set-text-xh text_200 fl" name="licenseid" id="licenseid" value="{$licenseid}" ><span id="iderror" style="color:red;">授权ID错误,请联系茄子户外运动售后客服人员!</span></li>
        <li class="h30"><span class="fl" style="width: 100%;line-height: 30px;">请填写购买茄子户外运动注册的官方帐号ID</span></li>
...
<div class="sj-outbox">
    ...
    <ul class="write-in">
        ...
        <li class="li_2" id="iderror"><p>授权ID错误,请联系茄子户外运动售后客服人员!</p></li>
        <li class="li_3"><p>您在茄子户外运动官方网站购买系统时的帐号所对应的ID。</p></li>
