    ...
    <!--右侧内容区-->
     ...
     <td valign="top" class="content-rt-td">
      ...
      <div>
        <form id="configfrm">
         <div class="w-set-con">
        	<div class="w-set-tit bom-arrow"><span class="on"><s></s>学分设置</span> <a href="javascript:;" class="refresh-btn" onclick="window.location.reload()">刷新</a></div>
          <div class="w-set-nr">
              ...
              <div class="picture ml-10">
                  ...
                  <p><span class="fl">登陆送学分：</span><input type="text" name="cfg_login_jifen" id="cfg_login_jifen" class="set-text-xh w70" value=""></p>
                  <p><span class="fl">注册送学分：</span><input type="text" name="cfg_reg_jifen" id="cfg_reg_jifen" class="set-text-xh w70" value=""></p>
                  <p><span class="fl">学分抵现金：</span>1元人民币 = <input type="text" name="cfg_exchange_jifen" id="cfg_exchange_jifen" class="w70" style="height: 24px;line-height: 24px;padding-left: 5px;border: 1px solid #dcdcdc;" value=""> 学分</p>
