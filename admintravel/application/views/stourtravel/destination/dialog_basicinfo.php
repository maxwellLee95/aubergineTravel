       ...
       <div class="main-body">
           <div class="nav">
               <div class="w-set-tit bom-arrow">
                   <span data-rel="seo" style="display: none"><s></s>优化信息</span>
                   <span  data-rel="jieshao" style="display: none" ><s></s>页面介绍</span>
                   <span data-rel="picture" class="on"><s></s>图片管理</span>
                   <span data-rel="template" style="display: none"><s></s>模板设置</span>
               </div>
           ...
           <div class="nav-list">
               ...
               <div class="item-one" id="item_seo"  style="display: none;">
                   <table>
               ...
               <div class="item-one" id="item_picture">
                   <table>
