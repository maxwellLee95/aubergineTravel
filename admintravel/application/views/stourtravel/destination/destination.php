...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div style="display: none"  class="search-bar filter" id="search_bar">
            ...
            columns: [
                ...
                // },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        var viewHtml='&nbsp;&nbsp;&nbsp;<a style="display: none" href="javascript:;" title="预览" class="row-view-btn" onclick="viewDest(\''+id+'\')"></a>';
