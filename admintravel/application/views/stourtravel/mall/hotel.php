...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="crumbs" id="dest_crumbs">
                <label>位置：</label>
                <a href="javascript:void(0);">首页</a> &gt; <a href="javascript:void(0);">设置中心</a> &gt; <a href="javascript:void(0);">基础设置</a> &gt; <span>商品列表</span>
   ...
   <span class="display-mod">
    ...
    <a href="javascript:void(0);" onClick="togMod(this,2)">规格</a>
...
Ext.onReady(
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            fields: ['id', 'aid', 'webid', 'title', 'mallrankid', 'telephone', 'mallkind', 'fuwu', 'shownum', 'kindlist', 'attrid', 'ishidden', 'displayorder', 'kindname', 'iconlist', 'attrname', 'themelist', 'tr_class', 'price', 'sellprice', 'breakfirst', 'computer'],
            proxy: {
                type: 'ajax',
                api: {
                    read: 'mall/action/read',  //读取数据的URL
                    update: 'mall/action/save',
                    destroy: 'mall/action/delete'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        if (!isNaN(id))
                            ...
                            return "&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:void(0);' class='suit-title' onclick='roomList("+mallid+")'>" + value + "</a>";
                        }
                    }
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record, rowIndex, colIndex) {
                        ...
                        if (!isNaN(id)) {
                            ...
                            var html = "<select onchange=\"updateField(this," + id + ",'mallrankid',0,'select')\"><option>所有</option>";
                            Ext.Array.each(window.rankmenu, function (row, index, itelf) {
                                var is_selected = row.aid == value ? "selected='selected'" : '';
                                html += "<option value='" + row.aid + "' " + is_selected + ">" + row.mallrank + "</option>";
                            });
                            html += "</select>";
                            return html;
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record, rowIndex, colIndex) {
                        ...
                        return "<a href='javascript:void(0);' onclick=\"roomList(" + id + ")\">规格管理</a>";
