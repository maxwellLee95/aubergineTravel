          ...
          <div class="manage-nr">
              ...
              <div class="add-class">
                  ...
                  <dl>
                      <dt>规格名称：</dt>
                      <dd>
                          <input type="text" name="name" id="name" class="set-text-xh text_700 mt-2" value="{$info['name']}" />
                      </dd>
                  </dl>
                  <dl>
                      <dt>规格说明：</dt>
                  ...
                  <dl>
                      <dt>库存：</dt>
                      <dd>
                          <input type="text" name="number" id="number" class="set-text-xh text_100 mt-2" value="{$info['number']}" />
                          <span class="fl ml-5">（当前可用库存数）</span>
                      </dd>
                  </dl>
                  <dl style="display: none">
                      <dt>床型：</dt>
            ...
            $('.uservalue').bind('input propertychange', function() {
              ...
              <div class="add-class">
                  ...
                  <dl>
                      ...
                      <dd>
                              ...
                              <div class="on-off">
                                  <input type="radio" checked="checked" name="paytype" value="1" {if $info['paytype']=='1'}checked="checked"{/if} />全款支付 &nbsp;
                                  <input style="display: none" type="radio" name="paytype" value="2" {if $info['paytype']=='2'}checked="checked"{/if} /><span style="display: none">定金支付 &nbsp;</span>
                                  <span  id="dingjin" style="{if $info['paytype'] == 'test2'}display:inline-block{else}display: none{/if}"><input style="display: none" type="text"  name="dingjin" id="dingjintxt" value="{$info['dingjin']}" size="8" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-\.]+/,'');}).call(this)" onblur="this.v();">&nbsp;元</span>
                                  <input style="display: none" type="radio" name="paytype" value="3"  {if $info['paytype']=='3'}checked="checked"{/if} /><span style="display: none">二次确认支付 &nbsp;</span>
                                  <input style="display: none" type="radio" name="paytype" value="4"  {if $info['paytype']=='3'}checked="checked"{/if} /><span style="display: none">线下支付 &nbsp;</span>
                  ...
                  <dl>
                      ...
                      <dd> <div class="price_con">
                              <div class="price_menu">
                                  ...
                                  <a style="display: none" href="javascript:;" class="{if $info['lastoffer']['pricerule']=='week'}on{/if}" data-val="week">按星期</a>
                                  <a style="display: none" href="javascript:;" class="{if $info['lastoffer']['pricerule']=='month'}on{/if}" data-val="month">按号数</a>
                              </div>
                              <div class="price_sub">
                                  <div>
                                      <table class="price_tb">
                                          ...
                                          <tr>
                                              <td class="tit">库存：</td><td><input type="text" class="set-text-xh text_100 mt-2" name="number" value="50"> <span style="color:gray;padding-left:10px"></span></td>
                                          </tr>
                                      </table>
              ...
              <!--/基础信息结束-->
                  ...
                  <div class="opn-btn" style="padding-left: 10px; " id="hidevalue">
                      ...
                      <input type="hidden" name="mallid" id="mallid" value="{$mallid}">
	...
	$(document).ready(function(){
        ...
        $("#btn_save").click(function(){
                ...
                if(name==''){
                   ...
                   Ext.Ajax.request({
                       url   :  SITEURL+"mall/ajax_room_save",
                       method  :  "POST",
                       isUpload :  true,
                       form  : "product_frm",
