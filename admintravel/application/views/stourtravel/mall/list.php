...
<head>
    <meta charset="utf-8">
    <title>茄子户外旅游CMS{$coreVersion}</title>
    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
                    ...
                    <table class="list-head-tb">
                        <tr>
                            <td class="head-td-lt">
                                ...
                                {/loop}
                                <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('配送方式','malldelivery/list/parentkey/product/itemid/202',1);">配送方式</a>
                            </td>
                            <td class="head-td-rt">
            ...
            <div class="search-bar filter" id="search_bar">
                <div  style="display: none"  class="change-btn-list mt-4 ml-10">
                ...
                <div class="pro-search ml-10" style=" float:left; margin-top:4px">
                    <input type="text" id="searchkey" value="商品名称/商品编号" datadef="商品名称/商品编号" class="sty-txt1 set-text-xh wid_200">
       ...
       <span style="display: none" class="list-3 fl"><a href="javascript:void(0);" title="供应商" onClick="CHOOSE.togMod(this,3)">供应商</a></span>
     </span>
            </div>
...
<script>
    ...
    echo  'window.rankmenu='.json_encode(Model_Mall_Rank::getList()).';';
    ...
    Ext.onReady(
        function()
        {
            ...
            $("#addbtn").click(function(){
                var url=SITEURL+"mall/add/parentkey/member/itemid/1";
                ST.Util.addTab('添加商品','{$cmsurl}mall/add/parentkey/product/itemid/<?php echo Model_Mall::TYPE_ID;?>',0);
            });
            ...
            window.product_store=Ext.create('Ext.data.Store',{
                ...
                proxy:{
                    type:'ajax',
                    api: {
                        read: SITEURL+'mall/mall/action/read',  //读取数据的URL
                        update:SITEURL+'mall/mall/action/save',
                        destroy:SITEURL+'mall/mall/action/delete'
                    },
                    reader:{
                        type: 'json',   //获取数据的格式
                        root: 'lists',
                                        ...
                                        items:[
                                            ...
                                            },
                                            {
                                                text: '属性', handler: function () {
                                                    CHOOSE.setSome("设置属性", {loadCallback: setAttrids}, SITEURL + 'attrid/dialog_setattrid?typeid=202');
                                                }
                                            },
                                            {
                                                text: '专题', handler: function () {
                                                    CHOOSE.setSome("设置专题", {loadCallback: setThemes}, SITEURL + 'theme/dialog_settheme?typeid=202');
                                                }
                                            },
                                            {
                ...
                columns:[
                    ...
                    },
                    {
                        ...
                        renderer : function(value, metadata,record) {
                            ...
                            if(id.indexOf('suit')!=-1)
                                metadata.tdAttr ="data-qtip='指同一商品下规格的显示顺序'"+"data-qclass='dest-tip'";
                            var newvalue=value;
                    ...
                    },
                    {
                        ...
                        renderer : function(value, metadata,record) {
                            ...
                            {
                                metadata.tdAttr ="data-qtip='点击跳转到规格设置页面'  data-qclass='dest-tip'";
                                return "<a href='javascript:void(0);' onclick=\"modSuit('"+roomid+"','"+mallid+"')\" class='suit-title'>&bull;&nbsp;&nbsp;"+value+"</a>";
                            }
                        }
                    ...
                    //             var html="<select onchange=\"updateField(this,"+id+",'mallrankid',0,'select')\" class='row-edit-select'><option>所有</option>";
                    //             Ext.Array.each(window.rankmenu, function(row, index, itelf) {
                    //                 var is_selected=row.id==value?"selected='selected'":'';
                    //                 html+="<option value='"+row.id+"' "+is_selected+">"+row.mallrank+"</option>";
                    //             });
                    //             html+="</select>";
                    //             return html;
                    //
                    ...
                    /* {
                         ...
                         renderer: function (value, metadata, record, rowIndex, colIndex) {
                             ...
                             return "<a href='javascript:void(0);' onclick=\"roomList(" + id + ",'"+mallname+"')\">规格管理</a>";
                    ...
                    // },
                    {
                        ...
                        renderer : function(value, metadata,record) {
                            ...
                            return "<a href='javascript:void(0);' title='编辑'  class='row-mod-btn' onclick=\"goModify("+id+")\"></a>"
                                +"&nbsp;&nbsp;<a href='javascript:void(0);' title='克隆' class='row-clone-btn' onclick=\"ST.Util.goClone("+id+",'mall')\"></a>";
                        },
                        listeners:{
                            afterrender:function(obj,eopts)
                            {
                    ...
                    // },
                    {
                        ...
                        renderer : function(value, metadata,record) {
                            ...
                            if(id.indexOf('suit')!=-1)
                            {
                                return "<a href='javascript:;' class='row-mod-btn' title='编辑' onclick=\"modSuit('"+roomid+"','"+mallid+"')\"></a>&nbsp;&nbsp;<a href='javascript:;' title='删除' class='row-del-btn' onclick=\"delSuit('"+id+"')\"></a>";
                            }
                            else
                                return '<a href="javascript:;"  class="row-add-suit-btn" onclick="ST.Util.addTab(\'添加规格\',\'mall/room_op/parentkey/product/itemid/<?php echo Model_Mall::TYPE_ID;?>/action/add/mallid/'+id+'\')">添加规格</a>';
    ...
    {
        var url = SITEURL+'mall/edit/parentkey/product/itemid/<?php echo Model_Mall::TYPE_ID;?>/id/'+id;

        parent.window.addTab('修改商品',url,0);
    }
    //规格管理
    function roomList(id,mallname)
    {
        var url = SITEURL+'mall/room/parentkey/product/itemid/<?php echo Model_Mall::TYPE_ID;?>/mallid/'+id;
        ST.Util.addTab(mallname,url);

    }
    //modSuit
    function modSuit(roomid,mallid)
    {
        //var mallid = $("#mallid").val();
        var url = SITEURL+'mall/room_op/parentkey/product/itemid/<?php echo Model_Mall::TYPE_ID;?>/action/edit/mallid/'+mallid+'/roomid/'+roomid;
        ST.Util.addTab('修改规格',url);
    }
    ...
    {
        CHOOSE.setSome("设置属性",{loadCallback:setAttrids},SITEURL+'attrid/dialog_setattrid?typeid=202&id='+id,true);
    }
    function setOneThemes(id)
    {
        CHOOSE.setSome("设置专题",{loadCallback:setThemes},SITEURL+'theme/dialog_settheme?typeid=202&id='+id,true);
    }
</script>
