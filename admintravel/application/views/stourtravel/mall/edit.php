     ...
     <td valign="top" class="content-rt-td">
          ...
          <div class="manage-nr">
              <div class="w-set-tit bom-arrow" id="nav">
                 ...
                 <!-- <span data-id="tupian"><s></s>商品图片</span>
                  <span data-id="jieshao"><s></s>商品介绍</span>
                  ...
                  {/loop}
                  <span style="display: none" data-id="youhua"><s></s>优化设置</span>
                  <span style="display: none" data-id="extend"><s></s>扩展设置</span>
                  ...
                  <div class="product-add-div">
                      <div class="add-class" >
                          ...
                          <dl>
                              <dt>商品名称：</dt>
                              <dd>
                                  <input type="text" name="title" id="mallname" class="set-text-xh text_700 mt-2"  value="{$info['title']}" />
                      ...
                      <div class="add-class" >
                          ...
                          <dl style="display: none">
                              ...
                              <dd>
                                  ...
                                  <select name="mallrankid">

                                      {loop $ranklist $k}
                                      <option value="{$k['id']}" {if $info['mallrankid']==$k['id']}selected="selected"{/if} >{$k['mallrank']}</option>
                                      {/loop}
                      ...
                      <div class="add-class" >
                          ...
                          <dl >
                              <dt>显示数据：</dt>
                              <dd>
                                  <span style="display: none" class="fl">推荐次数</span>
                                  <input style="display: none" type="text" name="recommendnum" id="yesjian" data-regrex="number" data-msg="*必须为数字"  class="set-text-xh text_60 mt-2 ml-10 mr-30" value="{$info['recommendnum']}" />
                                  <span style="display: none" class="fl">满意度</span>
                                  <input style="display: none" type="text" name="satisfyscore" id="satisfyscore" data-regrex="number" data-msg="*必须为数字" class="set-text-xh text_60 mt-2 ml-10 mr-30" value="{$info['satisfyscore']}"  />
        ...
        $("#btn_save").click(function(){
            ...
            //验证商品名称
             if(mallname==''){
                   $("#nav").find('span').first().trigger('click');
                   $("#mallname").focus();
                   ST.Util.showMsg('请填写商品名称',5,2000);
               }
               else
               {
                   Ext.Ajax.request({
                       url   :  SITEURL+"mall/ajax_save",
                       method  :  "POST",
                       isUpload :  true,
                       form  : "product_frm",
                       waitMsg  :  "保存中...",
