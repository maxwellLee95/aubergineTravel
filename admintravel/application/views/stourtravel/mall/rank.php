...
<head>
    <meta charset="utf-8">
    <title>商品星级管理-茄子户外旅游CMS{$coreVersion}</title>
        ...
        <td valign="top" class="content-rt-td">
                    <div class="w-set-con">
                        <div class="w-set-tit bom-arrow">
                            {template 'stourtravel/mall/kind_top'}
...
<script>
    ...
    function getRankList()
    {
        ...
        $.getJSON(SITEURL+"mall/ajax_ranklist","webid="+webid,function(data){
    ...
    {
        var webid=0;
        var ajaxurl = SITEURL+'mall/ajax_rank_save';
    ...
    function add()
    {
        /* $.ajax({
         type:'POST',
         url:SITEURL+'mall/ajax_rank_add',
         dataType:'json',
    ...
    function del(id,obj)
    {
        ST.Util.confirmBox('删除星级','确定删除吗?',function(){
            ...
            {
                var boxurl = SITEURL+'mall/ajax_rank_del';
