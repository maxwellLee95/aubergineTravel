            ...
            <div class="list-top-set">
                ...
                <div class="list-web-ct">
                    <table class="list-head-tb">
                        <tr>
                            <td class="head-td-lt">
                                <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('赏金提现','leaderbounty/list',1);">赏金提现</a>
                                <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('证书列表','leadercertificate/list',1);">证书列表</a>
                                <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('证书审核列表','leadercertification/list',1);">证书审核列表</a>
                                <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('考试安排','leaderexam/list',1);">考试安排</a>
                                <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('考试结果','leaderexamresult/list',1);">考试结果</a>
                                <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('总结','leaderreport/list',1);">总结</a>
                            </td>
                            <td class="head-td-rt">
    ...
    Ext.onReady(
        function()
        {
            ...
            $("#addbtn").click(function(){
                ST.Util.addTab('添加领队',SITEURL+'leader/add/parentkey/sale/itemid/303');
            });

            //产品store
            window.product_store=Ext.create('Ext.data.Store',{
                fields:['id','nickname','addtime','modtime','status'],
                proxy:{
                    type:'ajax',
                    api: {
                        read: SITEURL+'leader/list/action/read',  //读取数据的URL
                        update:SITEURL+'leader/list/action/save',
                        destroy:SITEURL+'leader/list/action/delete'
                    },
                    reader:{
                        type: 'json',   //获取数据的格式
                        root: 'lists',
            ...
            window.product_grid=Ext.create('Ext.grid.Panel',{
                ...
                columns:[
...

                    {
                        ...
                        dataIndex:'id',
                        renderer : function(value, metadata,record) {
                            return "<a href='javascript:;' class='row-mod-btn' onclick=\"ST.Util.addTab('修改"+"','"+SITEURL+"leader/edit/parentkey/sale/itemid/303/id/"+value+"')\"></a>";
