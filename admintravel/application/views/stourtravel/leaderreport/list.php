        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="search-bar filter" id="search_bar">
                <div class="pro-search ml-10 mt-4 fl mt-4">
                    <input type="text" id="id" placeholder="考试ID" datadef="考试ID" class="sty-txt1 set-text-xh wid_200" />
...
<script>
    ...
    Ext.onReady(
        function()
        {
            ...
            $("#addbtn").click(function(){
                ST.Util.addTab('添加',SITEURL+'leaderreport/add/parentkey/sale/itemid/');
            });

            //产品store
            window.product_store=Ext.create('Ext.data.Store',{
                fields:['id','add_time','content','leader','line','title','up_time','day'],
                proxy:{
                    type:'ajax',
                    api: {
                        read: SITEURL+'leaderreport/list/action/read',  //读取数据的URL
                        update:SITEURL+'leaderreport/list/action/save',
                        destroy:SITEURL+'leaderreport/list/action/delete'
                    },
                    reader:{
                        type: 'json',   //获取数据的格式
                        root: 'lists',
            ...
            window.product_grid=Ext.create('Ext.grid.Panel',{
                ...
                columns:[
                    ...
                    },
                    {
                        ...
                        dataIndex:'id',
                        renderer : function(value, metadata,record) {
                            return "<a href='javascript:;' class='row-mod-btn' onclick=\"ST.Util.addTab('查看"+"','"+SITEURL+"leaderreport/edit/parentkey/sale/itemid/1/id/"+value+"')\"></a>";
    ...
    function searchKeyword() {
        var id = $.trim($("#id").val());
        window.product_store.getProxy().setExtraParam('id',id);
