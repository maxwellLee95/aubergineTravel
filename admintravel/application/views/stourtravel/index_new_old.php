        ...
        <ul class="fl">
            ...
            <li class="manager">
                ...
                <div class="top-help-list">
                    <a class="ico_1" target="_blank" href="http://www.xxx.com/peixun/yingxiao-19">使用帮助</a>
                    <a class="ico_2" target="_blank" href="javascript:;">视频教程</a>
                    <a class="ico_3" target="_blank" href="http://www.xxx.com/Member/login">意见反馈</a>
                    <a class="ico_4" target="_blank" href="http://www.xxx.com">茄子户外运动官网</a>
                    <a class="ico_5" target="_blank" href="http://www.xxx.com/cms/jieshao">关于系统</a>
                </div>
            </li>
...
<div class="gn-ts-cum">
    ...
    <p id="info1" style="display: none">欢迎使用茄子户外运动！您已获取官方正版授权,受法律保护!</p>
    <p id="info2" style="display: none">您还未获得茄子户外运动的正版授权，盗版使用会面临刑法处罚，请<a href="http://www.xxx.com/cms/accredit" target="_blank">联系我们</a></p>
...
<div class="best_news" style="display: none">
  ...
  <div class="news_con" onClick="window.open('http://www.xxx.com/cms/banben')">
  	<ul id="new_desc">
    ...
    <div class="st-sm-con">
        <dl>
            <dt>
                ...
                <a href="http://www.xxx.com/peixun/yingxiao-6" target="_blank">SEO优化</a>
                <a href="http://www.xxx.com/peixun/yingxiao-8" target="_blank">整合营销</a>
                <a href="http://www.xxx.com/peixun/yingxiao-7" target="_blank">社会化</a>
                <a href="http://www.xxx.com/peixun/yingxiao-60" target="_blank">行业</a>
                <a href="http://www.xxx.com/peixun/yingxiao-67" target="_blank">经营管理</a>
            </dt>
    ...
    $(function(){
        $(".main-nr-top ul li").click(function(){
            ...
            if(listid !='question'){
                ...
                window.open('http://www.xxx.com/Member/Login');
            }
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(i,row){
                    list+='<a href="http://www.xxx.com'+row.url+'" target="_blank">'+row.title+'</a>';
                });
