...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td">
            ...
            <form id="configfrm">
                <div class="w-set-tit bom-arrow"><span class="on"><s></s>茄子户外运动授权绑定</span> <a href="javascript:;" class="refresh-btn" onclick="window.location.reload()">刷新</a></div>
                <div class="empower_con">
                    ...
                    <dl class="ec_list">
                        ...
                        <dd>
                            ...
                            <p>注：在www.xxx.com购买系统使用的帐号；    还没有帐号？<a href="http://www.xxx.com/member/">立即注册</a></p>
                        </dd>
                    </dl>
                    <dl class="ec_list">
                        <dt>茄子户外运动密码：</dt>
                        <dd>
                            ...
                            <p>注：在www.xxx.com登录时使用的密码，若修改后，请务必修改此处密码，密码错误会影响系统功能使用，如短信功能；</p>
                        </dd>
                    </dl>
                    <dl class="ec_list">
                        <dt>茄子户外运动ID：</dt>
                        <dd>
                            ...
                            <p>注：在www.xxx.com会员中心的用户ID，即是系统的授权ID，请正确填写，否则会影响系统功能的使用，如升级功能；</p>
                        </dd>
                    </dl>
                    <div class="opn-btn">
