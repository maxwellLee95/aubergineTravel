              ...
              <div class="picture">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ml-10" style="display: table;" id="paytable" >
                      <tr>
                          <td colspan="2">
                              <ul class="paylist">
<!--                                  <li class=""><input  type="checkbox" name="alipay" value="1" {if strpos($config['cfg_pay_type'],'1')!==false} checked="checked"{/if}>支付宝</label></li>-->
...
<!--                                  <li class=""><input  type="checkbox" name="paypal" value="7" {if strpos($config['cfg_pay_type'],'7')!==false} checked="checked"{/if}>贝宝支付</li>-->
                                  <li class="active"><input  type="checkbox" name="weixinpay" value="8" {if strpos($config['cfg_pay_type'],'8')!==false} checked="checked"{/if}>微信支付</li>
                              </ul>
                          </td>
                      </tr>
                      </table>
                      <div class="pay-container" >
                          <div class="pay-one" id="pay_alipay" style="display: none">
                          ...
                          <div class="pay-one" id="pay_weixinpay" >
                              <div class="pay-sg">
                                  <table>
                                      <tr>
                                      ...
                                      <tr>
                                          <td class="tit"  style="width:100%" colspan="2"><span class="tit-sp">证书上传路径:</span><br/>
                                              <span class="tit-sp" style="padding-left:30px">证书目录：\payment\application\vendor\mobile\wxpay\cert目录下</span></td>
                                      </tr>
