          ...
          <div class="w-set-nr">
               <div id="m_basic_div" class="mitem water-mark" >
                  ...
                  <div class="nr-list">
                      ...
                      <div class="txt">
                          <input type="text" name="cfg_m_main_url" id="cfg_m_main_url" class="set-text" value="{$config['cfg_m_main_url']}" /><span class="must-input hide"><i>* 必填</i></span><span class="fanlie">没有绑定独立二级域名，请填写主站域名http://www.xxx.com，如：http://www.xxx.com；有绑定则填写参考：http://x.xxx.com，如：http://m.stourweb.com </span>
                      </div>
                  </div>
                  <div class="nr-list">
                      ...
                      <div class="txt">
                          ...
                          <span class="fanlie">请填写主站域名http://www.xxx.com，如：http://www.xxx.com；</span>
                      </div>
                  </div>
                  <div class="nr-list">
