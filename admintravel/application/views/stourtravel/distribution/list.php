                    ...
                    <table class="list-head-tb">
                        <tr>
                            ...
                            <td class="head-td-rt">
                                ...
                                <a style="display: none" href="javascript:;" id="addbtn" class="add-btn-class ml-10" >添加</a></td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    Ext.onReady(
        function()
        {
            ...
            $("#addbtn").click(function(){
                ST.Util.addTab('添加',SITEURL+'distribution/add/parentkey/sale/itemid/');
            });

            //产品store
            window.product_store=Ext.create('Ext.data.Store',{
                fields:['id','distribution_id','order_id','commission','commission_rate','order_price','add_time','status','form_member','to_member','up_time','status_name'],
                proxy:{
                    type:'ajax',
                    api: {
                        read: SITEURL+'distribution/list/action/read',  //读取数据的URL
                        update:SITEURL+'distribution/list/action/save',
                        destroy:SITEURL+'distribution/list/action/delete'
                    },
                    reader:{
                        type: 'json',   //获取数据的格式
                        root: 'lists',
