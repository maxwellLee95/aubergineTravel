                    ...
                    <div class="product-add-div" id="content_basic">
                        <div class="add-class">
                            ...
                            <dl>
                                <dt>描述：</dt>
                                <dd>
                                    <input type="text" class="set-text-xh text_700 mt-2" name="desc" value="{$info['desc']}">
                                </dd>
                            </dl>
                            <dl>
                                <dt>积分：</dt>
                                <dd>
                                    <input type="text" class="set-text-xh text_700 mt-2" name="integral" value="{$info['integral']}">
                                </dd>
                            </dl>
                        </div>
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#btn_save").click(function(){
            ...
            Ext.Ajax.request({
                url   :  SITEURL+"leadercertificate/ajax_save",
                method  :  "POST",
                isUpload :  true,
                form  : "product_fm",
                datatype  :  "JSON",
