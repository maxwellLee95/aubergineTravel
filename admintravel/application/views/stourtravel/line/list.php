...
<div class="list-top-set">
                ...
                <table class="list-head-tb">
                    <tr>
                        <td class="head-td-lt">
                            ...
                            {/loop}
                            <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('集合点','marshalpoint/list',1);">集合点</a>
                            <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('物资','material/list',1);">物资</a>
                            <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('分销','distribution/list',1);">分销</a>
                            <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('佣金提现','commission/list',1);">佣金提现</a>
 ...
 <div class="search-bar filter" id="search_bar">
     <div class="change-btn-list mt-4 ml-10" style="display: none">
     ...
     <div class="change-btn-list mt-4  ml-10">
       <span class="change-btn-xz btnbox" id="attrlist" data-url="box/index/type/attrlist/typeid/1" data-result="result_attrlist" >属性&nbsp;&gt;&nbsp;<span id="result_attrlist">全部</span></span>
        ...
        <input type="text" id="searchkey" value="线路名称/产品编号" datadef="线路名称/产品编号" class="sty-txt1 set-text-xh wid_200">
     ...
     <span class="display-mod">
       ...
       <span class="list-3 fl" style="display: none"><a href="javascript:void(0);" title="供应商" onClick="CHOOSE.togMod(this,3)">供应商</a></span>
     </span>
   </div> 
               ...
               },
			   {
				   ...
				   renderer : function(value, metadata,record) {
					  //  return  "<input type='checkbox' class='product_check' value='"+value+"'/>"; 
									 ...
									 if(!isNaN(id))
			                           return "<a href='javascript:void(0);' class='line-title' target='_blank'>"+value+"&nbsp;&nbsp;"+iconname+"</a>";
					  ...
					  //  return  "<input type='checkbox' class='product_check' value='"+value+"'/>"; 
                                     ...
                                     var name=record.get('title');
			                          if(id.indexOf('suit')!=-1)
                                      {
									     ...
									     return "<a href='javascript:;' class='row-mod-btn' title='修改套餐'  onclick=\"ST.Util.addTab(\'修改套餐\',\'line/editsuit/parentkey/product/itemid/1/suitid/"+suitid+"\')\"></a>&nbsp;&nbsp;<a style='display: none' href='javascript:void(0);' title='删除' class='row-del-btn' onclick=\"delSuit('"+id+"')\"></a>";
                                      }
                                      else
                                      {
                                          return '<a style="display: none" href="javascript:;" class="row-add-suit-btn" onclick="ST.Util.addTab(\'添加套餐\',\'line/addsuit/parentkey/product/itemid/1/lineid/'+id+'\')">添加套餐</a>';
                                      }
					},				 
				   listeners:{
					    afterrender:function(obj,eopts)
