              ...
              <div class="add-class">
                  ...
                  <dl>
                      ...
                      <dd>
                              ...
                              <div class="on-off">
                                  <input type="radio" name="paytype" value="1" {if $info['paytype']=='1' || empty($info['paytype'])}checked="checked"{/if} /><span>全款支付 &nbsp;</span>
                                  ...
                                  <span id="dingjin" style="{if $info['paytype'] == '2'}display:inline-block{else}display: none{/if}">
                                      <input type="text"  name="dingjin" id="dingjintxt" value="{$info['dingjin']}" size="8" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-\.]+/,'');}).call(this)" onblur="this.v();">&nbsp;元</span>
                              ...
                              <div class="price_sub">
                                  <div>
                                      <table class="price_tb">
                                          ...
                                          <tr>
                                              <td class="tit">适用人群：</td>
                                              <td class="prop-group">
                                                  <input type="checkbox" name="propgroup[]" value="2" id="adultgroup"/><span>成人
                                                      &nbsp;&nbsp;&nbsp;</span>
                                                  <input type="checkbox" name="propgroup[]" value="1" id="childgroup"><span>儿童</span>
                                                  &nbsp;&nbsp;&nbsp;<input type="checkbox" name="propgroup[]" value="3" id="oldgroup"><span>老人</span>
                                              </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                              <td class="tit">库存：</td><td><input type="text" class="set-text-xh text_100 mt-2" name="number" value="50"> <span style="color:gray;padding-left:10px">该处的值仅为默认值，不代表设置值（所选日期的库存均变成该值）</span></td>
                                          </tr>
                                      </table>
 ...
 />
              ...
              <!--/基础信息结束-->
                  ...
                  <div class="opn-btn" style="padding-left: 10px; " id="hidevalue">
                      ...
                      <a class="normal-btn" id="btn_view_more" style="{if $action=='add'}display:none{/if}"   href="javascript:;" onclick="showMore()">查看报价/设置领队</a>
