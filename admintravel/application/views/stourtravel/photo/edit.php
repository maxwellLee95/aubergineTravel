    ...
    <td valign="top" class="content-rt-td" style="overflow:auto;">
            ...
            <div class="manage-nr">
                <div class="w-set-tit bom-arrow">
                    ...
                    <span style="display: none" id="column_image" onclick="Product.switchTab(this,'seo')"><s></s>优化信息</span>
                    <span  style="display: none" id="column_extend" onclick="Product.switchTab(this,'extend')"><s></s>扩展配置</span>
                        ...
                        <div class="add-class">
                            ...
                            <dl>
                                ...
                                <dd>
                                    <select name="line_id">
                                        {loop $line_list $row}
                                        <option value="{$row['id']}" {if $row['id']==$info['line_id']}selected="selected"{/if}>{$row['title']}</option>
                                        {/loop}
                                    </select>
                                </dd>
                            </dl>
