                        ...
                        <tr>
                            <td class="head-td-lt">
                                ...
                                <div id="sell_info_list" style="float:left;margin-left:10px">
                                    ...
                                    <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('游客列表','ordertourer/list',1);">游客列表</a>
                                </div>
                            </td>
                            <td class="head-td-rt">
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        // {
                        //
                        //     var html="<select disabled=\"disabled\" onchange=\"updateField(this,"+id+",'status',0,'select')\" class='row-edit-select'><option>所有</option>";
