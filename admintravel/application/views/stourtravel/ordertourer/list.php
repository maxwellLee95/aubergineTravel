        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="search-bar filter" id="search_bar">
                <div class="pro-search ml-10 mt-4 fl mt-4">
                    <input type="text" id="orderid" placeholder="订单号" datadef="订单号" class="sty-txt1 set-text-xh wid_200" />
...
<script>
    ...
    Ext.onReady(
        function()
        {
            ...
            $("#addbtn").click(function(){
                ST.Util.addTab('添加',SITEURL+'ordertourer/add/parentkey/sale/itemid/');
            });

            //产品store
            window.product_store=Ext.create('Ext.data.Store',{
                fields:['id','ordersn','productname','tourername','sex','cardtype','cardnumber','mobile'],
                proxy:{
                    type:'ajax',
                    api: {
                        read: SITEURL+'ordertourer/list/action/read',  //读取数据的URL
                        update:SITEURL+'ordertourer/list/action/save',
                        destroy:SITEURL+'ordertourer/list/action/delete'
                    },
                    reader:{
                        type: 'json',   //获取数据的格式
                        root: 'lists',
    ...
    function searchKeyword() {
        ...
        orderid = orderid==datadef ? '' : orderid;
        window.product_store.getProxy().setExtraParam('orderid',orderid);
