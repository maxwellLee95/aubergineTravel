    ...
    Ext.onReady(
        function()
        {
            ...
            $("#addbtn").click(function(){
                ST.Util.addTab('添加',SITEURL+'leaderexam/add/parentkey/sale/itemid/');
            });

            //产品store
            window.product_store=Ext.create('Ext.data.Store',{
                fields:['id','title','date','questions_count','addtime','uptime'],
                proxy:{
                    type:'ajax',
                    api: {
                        read: SITEURL+'leaderexam/list/action/read',  //读取数据的URL
                        update:SITEURL+'leaderexam/list/action/save',
                        destroy:SITEURL+'leaderexam/list/action/delete'
                    },
                    reader:{
                        type: 'json',   //获取数据的格式
                        root: 'lists',
            ...
            window.product_grid=Ext.create('Ext.grid.Panel',{
                ...
                columns:[
                    ...
                    },
                    {
                        ...
                        dataIndex:'id',
                        renderer : function(value, metadata,record) {
                            return "<a href='javascript:;' class='row-mod-btn' onclick=\"ST.Util.addTab('修改"+"','"+SITEURL+"leaderexam/edit/parentkey/sale/itemid/1/id/"+value+"')\"></a>";
