...
class Controller_Index extends Stourweb_Controller{
    ...
    {
        $article = Common::objectToArray(json_decode(Common::http('www.xxx.com/Api/index')));
...
//            '8'=>'visa',
    ...
    public function action_feedback()
    {
        ...
        $url="http://www.xxx.com/user/login/do_user_login/account/{$userName}/password/{$password}";
        echo '<script>'.
