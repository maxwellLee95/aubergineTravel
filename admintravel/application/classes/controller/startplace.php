...
class Controller_Startplace extends Stourweb_Controller{
  ...
  * */
    public function action_edit()
    {
        ...
        $info = ORM::factory('startplace',$id)->as_array();
        $this->assign('info',$info);
        $this->display('stourtravel/startplace/edit');
    }
 ...
 * */
    public function action_ajax_save()
    {
        ...
        {
            $model = ORM::factory('startplace')->where('id','=',$id)->find();

        }

        $model->cityname = ARR::get($_POST,'cityname');
        $model->icon = ARR::get($_POST,'icon');
