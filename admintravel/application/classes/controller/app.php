...
class Controller_App extends Stourweb_Controller{
    ...
    public function action_upgrade()
    {
        ...
        Common::sendInfo();
        $this->assign('version','茄子户外运动'.$cVersion.$versiontype);
    ...
    public function action_other()
    {
        ...
        {
            case 'contract':
                $url = "http://www.xxx.com/Member";
                break;
            case 'moban':
                $url = "http://www.xxx.com/cms/moban";
                break;
            case 'seo':
                $url = "http://www.xxx.com/peixun";
                break;
            case 'problem':
                $url = "http://www.xxx.com/cms/problem";
                break;
    ...
    public function action_ajax_upgrade_step3()
    {
        ...
        //$ws = "http://www.update.local/service/api.asmx?WSDL";//webservice服务的地址
        $ws = "http://www.update.local/service/api_v2.asmx?WSDL"; //v2接口
