            ...
            <div class="city-list-main">
                ...
                <div class="citys-main">
                    <?php $n=1; if(is_array($city_list)) { foreach($city_list as $city) { ?>
                        <div class="city"  onclick="doChangeCity( <?php echo $city['id'];?> );">
                            <div>
                                <img src="<?php echo $city['icon'];?>" style="width:100%;">
                            </div>
                            <div><?php echo $city['cityname'];?></div>
                        </div>
                    <?php $n++;}unset($n); } ?>
                </div>
            </div>
    ...
    <div class="top-module">
        <form id="searchForm" method="get" action="/phone/search" onsubmit="return checkNull()">
            <div class="search flex-div justify-between">
                ...
                <?php } else { ?>
                    <div class="flex-center city-show" onclick="changeCity(this);">
                        <div><?php echo $city_list['0']['cityname'];?></div>
                        <img src="/phone/public/images/wechat/v5/arrow_down.png" height="7">
                    </div>
                <?php } ?>
        ...
        <div class="banners">
            <!-- 图片轮播 -->
            <?php require_once ("/data/web/qiezi_travel/phone/taglib/ad.php");$ad_tag = new Taglib_Ad();if (method_exists($ad_tag, 'getad')) {$data = $ad_tag->getad(array('action'=>'getad','name'=>'s_index_1',));}?>
            <?php if($data['aditems']) { ?>
            ...
            <div class="navs flex-div">
                <?php require_once ("/data/web/qiezi_travel/phone/taglib/channel.php");$channel_tag = new Taglib_Channel();if (method_exists($channel_tag, 'getchannel')) {$data = $channel_tag->getchannel(array('action'=>'getchannel','row'=>'100',));}?>
                <?php $n=1; if(is_array($data)) { foreach($data as $row) { ?>
                <div class="nav-btn" style="width:20%;">
                    <a onclick="jumpNavUrl(this);"
                       data-url="<?php echo $row['url'];?>" data-bid="1">
                        <div class="div-center">
                            <img class="button-img"
                                 src="<?php echo $row['ico'];?>">
                        </div>
                ...
                <div class="news flex-start">
                    ...
                    <div id="news">
                        <div class="scrollText">
                            ...
                            <ul>
                                <?php $n=1; if(is_array($top_msg)) { foreach($top_msg as $row) { ?>
                                <li>
                                    <a href="javascript::void(0)">
                                        <span><?php echo $row['nickname'];?> 报名了 <?php echo $row['productname'];?></span>
                                    </a>
                                </li>
                                <?php $n++;}unset($n); } ?>
                            </ul>
                ...
                <div class="tab-swipers" style="min-height: 225px">
                    ...
                    <div class="tab-swiper-main ">
                        <div class="swiper-container tab-swiper" id="tabSwiper0">
                            <div class="swiper-wrapper">
                                <?php if(count($indexmodule1)>=6) { ?>
                                    <?php $n=1; if(is_array($indexmodule1)) { foreach($indexmodule1 as $e => $row) { ?>
                                        <?php if($e % 6==0 ) { ?>
                                        <div class="swiper-slide flex-div" style="width:100%; padding:0 5px;">
                                            ...
                                            ?>
                                            <a href="<?php echo $indexmodule1[$d]['url'];?>"
                                                ...
                                                <div style="padding:0 5px;position: relative;">
                                                    <div class="flex-div">
                                                        <div class="modal15-line-img lazy-img-loading" style="display:inherit;"
                                                             data-img="<?php echo $indexmodule1[$d]['index_litpic'];?>"
                                                             data-type="1"></div>
                                                    </div>
                                                    <div class="line-name text-left"><?php echo $indexmodule1[$d]['index_title'];?></div>
                                                    <div class="line-info">
                                                        <div class="pull-left"><?php echo Common::date_text_week($indexmodule1[$d]['day']);?></div>
                                                        <div class="pull-right">
                                                            <div class="status tab-status <?php echo $indexmodule1[$d]['status']['style'];?>">
                                                                <?php echo $indexmodule1[$d]['status']['name'];?>
                                                            </div>
                                                        </div>
                                                        <div class="clear"></div>
                                                    </div>
                                    ...
                                    <div class="swiper-slide flex-div" style="width:100%; padding:0 5px;">
                                        ...
                                        <a href="<?php echo $row['url'];?>"
                                           style="width:33.33%; padding-bottom:10px;">
                                            <div style="padding:0 5px;position: relative;">
                                                <div class="flex-div">
                                                    <div class="modal15-line-img lazy-img-loading" style="display: inherit; background-image: url(<?php echo $row['index_litpic'];?>);height: 130px;"
                                                         data-img="<?php echo $row['index_litpic'];?>"
                                                         data-type="1"></div>
                                                </div>
                                                <div class="line-name text-left"><?php echo $row['index_title'];?></div>
                                                <div class="line-info">
                                                    <div class="pull-left"><?php echo Common::date_text_week($row['day']);?></div>
                                                    <div class="pull-right">
                                                        <div class="status tab-status <?php echo $row['status']['style'];?>">
                                                            <?php echo $row['status']['name'];?>
                                                        </div>
                                                    </div>
                                                    <div class="clear"></div>
                                                </div>
            ...
            <div class="flex-div index-modal modal29" data-style="29" data-position="4" data-module="4">
                <div class="index-modal-content">
                    <div class="flex-div modal29-list">
                        <?php $n=1; if(is_array($indexmoudle4)) { foreach($indexmoudle4 as $row) { ?>
                        <div class="modal29-img"  style="background-image:url(<?php echo $row['index_litpic'];?>); width:100%;">
                            <a href="<?php echo $row['url'];?>">
                                <div class="flex-center" style="height:100%;">
                                    <div class="text-center">
                                        <div class="modal29-name"><?php echo $row['index_title'];?></div>
                                        <div class="modal29-desc">[<?php echo $row['index_sub_title'];?>]</div>
                                    </div>
                                </div>
                            </a>
                        </div>
