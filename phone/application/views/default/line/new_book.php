        ...
        <div class="topBar">
            <div class="line-step">
                ...
                <div class="line-step-jump">
                    <a class="line-step-a" href="/phone/flop/time?aid={$info['id']}"></a>
                </div>
            </div>
...
<div id="my_member" style="display:none;">
    ...
    <ul class="member-content">
        {loop $linkman $row}
        <li class="member-li contact-li" id="li_{$row['contactId']}">
            <div class="fl" style="width:80%;">
                <div class="member-info member-name">
                    姓名：
                    <span id="n">{$row['realName']}</span>
                    {if !empty($row['isdefault']) }
                    <span id="sdf_c_{$row['contactId']}" data-val="{$row['contactId']}" class="df">默认</span>
                    {else}
                    <span id="sdf_c_{$row['contactId']}" data-val="{$row['contactId']}" class="sf purple" onclick="setDefault({$row['contactId']})">设为默认</span>
                    {/if}
                    <div class="pull-right green edit-contact-btn" onclick="editContact( {$row['contactId']} );">
                        编辑
                    </div>
                </div>
                <div class="member-info member-idcard">
                    身份证：
                    <span id="i">{$row['identity']}</span>
                </div>
                <div style="display: none" class="member-info member-sex">
                    性别：
                    <span id="x">{$row['sexName']}</span>
                </div>
                <div class="member-info member-phone">
                    电话号码：
                    <span id="t">{$row['telephone']}</span>
                </div>
            </div>
            <div class="fr mm_check" style="width:20%;" pass-num="{$row['passNum']}" pass-addr="{$row['passAddr']}" pass-type="{$row['passType']}" data-val="{$row['contactId']}" identity-type="1" birthday="{$row['birthday_str']}" sex="1" onclick="selectMember($(this));">
                <span id="c_{$row['contactId']}" class="mem-unselect"></span>
            </div>
            <div class="clear"></div>
        </li>
        {/loop}
...
<div id="join-content" class="content">
    <div class="join">
        <form id="form" >
            ...
            <input type="hidden" name="suitid" id="suitid" value="{$suit['suitid']}"/>
            ...
            <input type="hidden" name="startdate" id="startdate" value="{$suit['day']}"/>
            ...
            <div id="member">
                <ul  class="signups" data-index="0">
                    <li>
                        ...
                        <div class="right">
                            <input id="realname0" type="text" name="realname0" value="{$default_linkman['realName']}" placeholder="（与证件名字一致）" class="required realname"
                            />
                        </div>
                        <div style="clear: both;"></div>
                    </li>
...
<!--                                    <option class="type6" value="6" >其他</option>-->
                        ...
                        <div class="right">
                            <input id="idcard0" type="text" value="{$default_linkman['identity']}" idType="" name="idcard0" placeholder="（与证件号码一致）" onblur="checkIdCardInput( this );" class="idCardInput required"
                            />
                        </div>
                        <div style="clear: both;"></div>
                    </li>
                    ...
                    <li class="sex-li" style="display:none;">
                        ...
                        <div class="right sex">
                            <label>
                                男 <input id="sexM0" {if $default_linkman['sex']==1} checked="checked"  {/if} class="sexRadio radio pd-l-5" type="radio" name="sex0" value="1"  />
                            </label>
                            <label>
                                女 <input id="sexW0" {if $default_linkman['sex']==0} checked="checked"  {/if} class="sexRadio radio pd-l-5" type="radio" name="sex0" value="2"  />
                            </label>
                        </div>
                        <div style="clear: both;"></div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="right">
                            <input id="tel0" type="text" name="tel0" value="{$default_linkman['telephone']}" placeholder="（必填）" oninput="this.value = (this.value.replace(/\s+/g, ''));" onafterpaste="this.value = (this.value.replace(/\s+/g, ''));" class="mobileInput required"
                            />
                        </div>
                        <div style="clear: both;"></div>
                    </li>
            ...
            <ul>
                <li>
                    <div class="pull-left" style="padding-right:10px; width:30%;">{date('m月d日',$suit['day'])}</div>
                    <div class="pull-left" style="text-align:right;padding-left:5px; width:70%;">{$info['startcity']}出发</div>
                    <div style="clear: both;"></div>
                </li>
            </ul>
            <div id="activity-fee">
            ...
            <ul id="activity-fee-list">
                <li>
                    ...
                    <div class="pull-left">
                        <span id="baseMoney" class="">{$info['price']}</span>元/人
                    </div>
...
<script type="text/javascript">
    ...
    var scoreExchangeRate = {$score_arr['exchange']}; //学分的折算比例
    var isUseScore = false; //是否使用学分
    var canUseScore = {$score_arr['userScore']}; //可使用的学分
    var useScore = {$score_arr['availableUseScore']}; //用户使用的学分
