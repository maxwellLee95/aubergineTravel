...
<body>
                ...
                <ul>
                    ...
                    <li>
                        <a href="{$articlerow['url']}">
                            <div class="pic"><img src="/public/images/grey.gif" st-src="{Common::img($articlerow['litpic'],246,244)}" alt="{$articlerow['title']}" /></div>
                            <div class="con">
    ...
    <script type="text/html" id="tpl_new_article">
        ...
        <li>
            <a href="{{value.url}}">
                <span class="pic"><img src="/public/images/grey.gif" st-src="{{value.litpic}}" alt="{{value.title}}" /></span>
