...
<html>
<head>
    <title>茄子户外运动·{$info['nickname']}的游记</title>
    <meta charset="UTF-8">
...
<style type="text/css">
    ...
    a.uploadImgBtn {
        ...
        width: 24px;
        height: 34px;
        background-image: url('/images/wechat/vi.png');
        background-size: 100%;
    ...
    .audio-left .audio-player-img {
        ...
        cursor: pointer;
        background-color: #fff;
        background-image: url('/phone/public/public/images/ugc/player.png');
        background-repeat: no-repeat;
        background-position: center;
...
<div class="content-body">
    ...
    <div class="content">
        ...
        <div class="content-main">
            <!-- 游记封面 -->
            <div class="banner">
                <div class="banner-img" style="height: 194.4px;">
                    <video id="banner-video" controls="controls" preload="auto"
                           src="{$info['video']}"
                           class="video-elem" data-id="2642" data-vtab="1" poster="null" style="height: 194.4px;">
                        当前浏览器，暂不支持视频播放，请更换其他浏览器
                    </video>
                    <div class="item-video-length"></div>
                </div>
            </div>
            <!-- 游记信息 -->
        ...
        <div class="end" id="end">
            ...
            <div class="author-info">
                <div class="flex-div" style="padding:0 20px;">
                    ...
                    <div  class="text-right flex-end" style="width:31%;display: none">
                        <span class="article-sub" onclick="follow(this);" follow-status="1" data-tollowtype="0">+ 关注</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="display: none" class="comments" id="comments">
                ...
                <div style="width:85%; line-height:22px;">
                    <div style="position:relative;">
                        <div class="marks" style="display: none">
                            <div class="mark" data-id="18">
                                <img class="mark-img" src="/phone/public/image/2017/07/11/325fe55900bc889ab822c0e59d2b1a1f.png" style="width:100%;">
                            </div>
                        </div>
                        <div class="comment-main">
                            <div class="comment-hiker">
                                <div>
                                    {$row['nickname']}
                                    <div class="pull-right flex-single" style="display: none">
                                        <div class="show-mark " onclick="showMarks(this);" data-floor="24" data-comment-id="15322">
                                            我戳
                                        </div>
                                        <div class="reply-show" replyname="最初" >回复</div>
                                    </div>
                                </div>
                    ...
                    <div class="comment-replys" style="display: none" >
                        ...
                        <div class="comment-reply" replyname="贝贝" onclick="showReply( 24, 15357, 15322, 192248, this, 1 );">
                            <span>贝贝</span>
                            &nbsp;回复&nbsp;<span>最初</span>
                            ：好哈，一起约起来                                    </div>
                    </div>
