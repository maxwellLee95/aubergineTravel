...
<div class="integral" id="integral" data="total:{$jifen['userjifen']},exchange:{$jifen['exchange']}"
     style="display: none">
    <p class="tl">学分抵现<span>您有 {$jifen['userjifen']} 学分可用</span></p>

    <p class="use">使用<strong><span id="jifen-need"></span></strong>学分，抵现<strong>¥<span id="jifen-price"></span></strong><i
            class="usejifen"></i></p>
</div>
<script>
