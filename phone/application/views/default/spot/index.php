        ...
        <div class="st_list_con">
            ...
            {st:spot action="query" flag="order" row="4"}
               {loop $data $row}
                <li>
                    <a href="{$row['url']}">
                    <img src="/public/images/grey.gif" st-src="{Common::img($row['litpic'],302,180)}" />
                    ...
                    <ul class="st_list_ul">
                        ...
                        <li>
                            <a href="{$h['url']}">
                                ...
                                {if $h['price']}
                                 <p class="num"><span><i class="currency_sy">{Currency_Tool::symbol()}</i><strong>{$h['price']}</strong>起</span></p>
								 {else}
                        <p class="num">
                            <span><strong>电询</strong></span>
                        </p>
