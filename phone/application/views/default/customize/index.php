    ...
    <div class="list">
        ...
        <div class="line">
            <div class="line-img relative">
                <a href="{$row['custom_promotion_link']}">
                    ...
                    <div class="activity-name"><span style="float: left;">{$row['startcity']}</span><span style="float: right">￥{$row['storeprice']}</span></div>
                </a>
            </div>
            <div class="line-name flex-center">
                <div class="flex-center">{$row['title']}</div>
            </div>
            <div class="line-desc">
