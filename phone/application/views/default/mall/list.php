...
<script type="text/html" id="tpl_mall_item">
...
<script>
    ...
    function get_data() {
        ...
        var url = SITEURL + 'mall/ajax_mall_more/' + paramUrl;
        layer.open({
            type: 2,
            content: '',
            time: 20
        ...
        $.getJSON(url, {}, function (data) {
            if (data.list.length > 0) {
                var itemHtml = template('tpl_mall_item', data);
