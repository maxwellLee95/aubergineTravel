    ...
    <div class="mid_content">
        ...
        <div class="book_type">
            ...
            <div class="book_con_box">
                <ul>
                    {st:mall action="suit" productid="$info['id']"}
                    {loop $data $r}
        ...
        <form action="{$cmsurl}mall/create" id="orderfrm" method="post">
            <div class="book_type">
...
<script>
    ...
    function check_storage() {
        ...
        $.ajax({
            type: 'POST',
            url: SITEURL + 'mall/ajax_check_storage',
    ...
    function get_range_price() {
        ...
        var suitid = $("#suitid").val();
        var dingnum = $("#dingnum").val();
        var url = SITEURL + 'mall/ajax_range_price';
        var money=0;
    ...
    function get_mindate_book() {
        var suitid = $("#suitid").val();
        var url = SITEURL + 'mall/ajax_mindate_book'
