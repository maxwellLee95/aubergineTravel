...
<div id="scoreDet" class="page out">
    <div class="header_top bar-nav">
        ...
        <h1 class="page-title-bar">赏金提现</h1>
    </div>
    <div style="padding: 10px 40px;    float: right;"><a href="/phone/leader/bounty/order_list" >查看打赏记录>></a> </div>
...
<script>
    $(function(){
        ...
        function load(){
            ...
            $.getJSON('/leader/bounty/ajax_list', page, function (data) {
                if (data.status) {
                    var html = '';
                    for (var i = 0; i < data['list'].length; i++) {
                        var item = data['list'][i];
                        html += '<li><div class="txt">';
                        html += ' <strong class = "name" >提现申请</strong > ';
