...
<div class="content">
    <div class="cardsBox">
        <a href="/phone/leader/integral/list">
            <div class="cardBox flex-base justify-between items-center">
                <div>
                    <div class="flex-base justify-between items-center">
                        <div class="iconBox" style="background-image: url('/phone/public/images/wechat/account/score.png')" title="可用积分"></div>
                        <div>可用积分</div>
                    </div>
                </div>
                <div class="hasTriangle">{$leader['integral']}积分</div>
            </div>
        </a>
        <a href="/phone/leader/bounty/order_list" >
            <div class="cardBox flex-base justify-between items-center">
                <div>
                    <div class="flex-base justify-between items-center">
                        <div class="iconBox" style="background-image: url('/phone/public/images/wechat/account/money.png')" title="赏金"></div>
                        <div>赏金</div>
                    </div>
                </div>
    ...
    <div class="tipBox">
        ...
        <ul class="tipDetails">
            <li>1、赞赏提现说明</li>
            <li>需满10元或以上才可申请提现。一天只能提现一次。提现非即时到账，需等到茄子户外运动系统审核后才下发，一般1个工作日完成审核。</li>
        </ul>
    </div>
</div>
