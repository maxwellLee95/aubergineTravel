...
<div class="from-content">
    <!--顶部图片-->
    <form id="st_form" method="post" action="/phone/member/commission/ajax_edit" enctype="application/x-www-form-urlencoded">
        <div class="customMade_con">
            <h3 class="made_tit"><span>佣金提现申请</span></h3>
            <div class="made_con">
                <ul>
                    <input type="hidden" id="commission" name="commission" value="{$member['commission']}">
                    <li>
                        <strong class="bt">可提现金额</strong>
                        <input type="text" readonly class="mdd" value="￥<?php echo $member['commission']?$member['commission']:0?>" placeholder="可提现金额"/>
                    </li>
                    <li>
        ...
        $("body").delegate(".btn_save", 'click', function () {
            ...
            $('#st_form').validate({
                ...
                showErrors: function (errorMap, errorList) {
                    ...
                    $.post('/phone/member/commission/ajax_edit',params, function (data) {
                        if (data.status == 1) {
                            layer.open({
                                content: data.message,
                                time: 2,
                                end:function(){
                                    /phone/member/commission/list
                                }
                            });
                        }else{
                            layer.open({
