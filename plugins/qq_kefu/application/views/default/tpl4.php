<style>
    ...
    .st-online-box .online-tit:before{
        ...
        margin:-3px 7px 0 0;
        background:url({$GLOBALS['cfg_res_url']}/images/tpl4/st-side-kf.png) no-repeat 0 bottom}
    ...
    .st-online-box .online-list dd a:before{
        ...
        vertical-align:middle;
        margin:-3px 2px 0 0;
        background:url({$GLOBALS['cfg_res_url']}/images/tpl4/st-side-kf.png) no-repeat 0 0}
